		...
		<div className={styles.container}>
			<div className={styles.wrapper}>
				...
				<div className={styles.item}>
					...
					<input type="text" placeholder='(012) 345-6789' className={styles.input} />
				</div>
				<div className={styles.item}>
					<label className={styles.label}>Address</label>
					<textarea rows={5} type="text" placeholder='Elton St. 505 NY' className={styles.textarea} onChange={(e) => setAddress(e.target.value)} />
				</div>
